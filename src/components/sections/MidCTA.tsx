    ...
    <section className="relative py-16 px-6">
      ...
      <div className="relative mx-auto max-w-2xl text-center">
        ...
        <Button size="lg" className="mt-8 text-lg px-8 py-6" asChild>
          <a
            href="https://pf.kakao.com/_hIFxgn/chat?mode=chat&input=%ED%99%88%ED%8E%98%EC%9D%B4%EC%A7%80%EC%97%90%EC%84%9C%20%EB%B3%B4%EA%B3%A0%20%EB%AC%B8%EC%9D%98%EB%93%9C%EB%A6%BD%EB%8B%88%EB%8B%A4."
            target="_blank"
            rel="noopener noreferrer"
            aria-label={MID_CTA.cta + " (새 창에서 열림)"}
          >
            {MID_CTA.cta}
          </a>
        </Button>
