...
export function Differentiators() {
  return (
    <section id="differentiators" className="relative scroll-mt-20 min-h-[80svh] flex flex-col justify-center py-20 px-6 border-y border-border/30">
      ...
      <div className="relative mx-auto max-w-4xl">
        <div className="text-center">
          ...
          <p className="mt-4 font-light leading-relaxed text-muted-foreground break-keep">
        ...
        <div className="mt-12 overflow-hidden rounded-xl border border-border bg-card">
          ...
          {DIFFERENTIATORS.comparisons.map((row, i) => (
            ...
            >
              <div className="px-6 py-4 text-sm text-muted-foreground/80 line-through decoration-muted-foreground/40 sm:border-r border-border">
        ...
        <p className="mt-10 text-center text-base font-light leading-relaxed text-muted-foreground break-keep whitespace-pre-line">
